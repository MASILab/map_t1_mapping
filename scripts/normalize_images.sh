...
for input_folder in /home/saundam1/temp_data/mp2rage_t1w_mask/*; do
    ...
    output_folder="/home/saundam1/temp_data/mp2rage_t1w_norm/$subj_id"
    
    mkdir -p $output_folder

    fslmaths /nfs/masi/saundam1/outputs/t1_mapping/mp2rage_t1w/$subj_id/t1w.nii.gz -add 0.5 -mas /nfs/masi/saundam1/outputs/t1_mapping/t1w_strip/$subj_id/mask.nii $output_folder/t1w.nii.gz
